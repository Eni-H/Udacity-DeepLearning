...
# print(reverse_dictionary.items())
...
# (Continuous Bag of Words). In the CBOW model, instead of predicting a context word 
# from a word vector, you predict a word from the sum of all the word vectors in its 
# context. Implement and evaluate a CBOW model trained on the text8 dataset.
